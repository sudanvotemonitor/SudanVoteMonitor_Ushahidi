		...
		<div class="big-block">
			...
			<div class="reports-box">
				...
				foreach ($incidents as $incident)
				{
					...
					$incident_thumb = "http://maps.google.com/maps/api/staticmap?center=".$incident->location->latitude.",".$incident->location->longitude."&zoom=6&size=100x100&maptype=roadmap&markers=color:red|size:mid|".$incident->location->latitude.",".$incident->location->longitude."&sensor=false";
